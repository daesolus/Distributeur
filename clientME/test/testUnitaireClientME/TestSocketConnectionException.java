...
public class TestSocketConnectionException extends TestCase {
	 ...
	 */
	public TestSocketConnectionException() {
		super(3, "TestSocketConnectionException");
	}

	public void SocketConnectionException1Test() {
		fail("Not Yet Implemented.");
	}

	public void SocketConnectionException2Test() {
		fail("Not Yet Implemented.");
	}
	...
	public void test(int testNumber) throws Throwable {
		switch (testNumber) {
		case 0:
			SocketConnectionException1Test();
			break;
		case 1:
			SocketConnectionException2Test();
			break;
		case 2:
			getMessage1Test();
			break;
